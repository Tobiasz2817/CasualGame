...
namespace Game.Scripts.Lobby {
    ...
    public class LobbyManager : SingletonPersistent<LobbyManager> {
        ...
        private void RateLimitInit() {
            _createRoomRL = new RateLimited(this, 6f, 2);
            _deleteRoomRL = new RateLimited(this, 1f, 2);
            _joinRoomRL = new RateLimited(this, 6f, 2);
            _quickJoinRoomRL = new RateLimited(this, 10f, 1);
            _heartbeatRL = new RateLimited(this, 30f, 5);
            _getLobbyRL = new RateLimited(this, 1f, 1);
            _removePlayerRL = new RateLimited(this, 5f, 1);
            _updateLobbyRL = new RateLimited(this, 5f, 5);
            _updatePlayerRL = new RateLimited(this, 5f, 5);
        }

        #region Create Room

        public async void CreateRoom(string roomName, int maxPlayers, CreateLobbyOptions options = null) {
            _createRoomRL.Call();

            if (!_createRoomRL.CanInvoke()) return;
        ...
        public async void JoinRoom(string enterCode, JoinLobbyByCodeOptions options = null) {
            _joinRoomRL.Call();
